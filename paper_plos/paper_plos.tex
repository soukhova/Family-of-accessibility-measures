...
Recall, accessibility is defined as ``the potential of spatial
interaction'' and is traditionally presented as a summary zonal measure.
In the doubly constrained case, we force the allocation of zonal
population demand and zonal opportunities supplied to be paired and
allocation to be proportional, hence the sum of \(V_{ij}^D\) for all
\(i\)s ends up being equal to the population at the zone (and
\(\sum_i V_{ij}^D\) being the opportunities at the zone).
