...
\textcolor{red}{Rafa: Do we have to shorthen the abstract? I actually preferred the abstract we had in the preprint. I like that the abstract mentions the toy example though, which was not done in the 1st version.}
...
Where $G$ is the gravitational constant--an empirically calibrated value that ensures the model reflects observed forces. Newton's initial estimate of $G$ was based on a speculation that the mean density of earth was between five or six times that of water, an assumption that received support after Hutton's and
Cavendish's experiments in the late 1700s [@hutton_xxxiii_1778; @cavendish_xxi_1798] to estimate of the proportionality constant to within 1% accuracy. In sum: it took over a century from the publication of *Principia* to refine the estimate of the proportionality constant.
...
\textcolor{red}{Rafa: there is no $\beta$ in this equation. Check text in paragraph below.}
